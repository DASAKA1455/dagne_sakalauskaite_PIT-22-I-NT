...
<div class="max-w-4xl mx-auto bg-surface p-8 rounded-xl shadow text-textPrimary">
    ...
    <div class="mb-10 bg-background p-6 rounded-lg shadow">
        ...
        <div class="mb-6 flex justify-end">
            <a href="{{ route('admin.users.index') }}"
               class="text-center bg-accent text-white px-4 py-4 rounded-lg shadow hover:bg-primary transition">
                {{ __('Manage users') }}
            </a>
        </div>
        @endcan
    ...
    <div class="mb-6 flex justify-end space-x-4">
        <a href="{{ route('admin.conferences.index') }}" class="...">Manage Conferences</a>
